...
const BonsPlans = () => {
  ...
  return (
    <Gui>
      <div>
        <div>
          <p className="text-2xl ourYellow font-bold pb-5 md:pb-5">Bons plans et astuces du moment</p>
        ...
        <div id="promosUnidays" className="grid grid-cols-1 grid-rows-3 md:grid-cols-4 md:grid-rows-5 gap-5 mt-14 md:mt-16">

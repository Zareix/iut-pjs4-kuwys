    ...
    <div className="grid border w-11/12 h-50 shadow-lg p-4 gap-3 text-lg">
      ...
      <fieldset className="grid gap-3 border px-4 pb-3 pt-2 mx-7 bg-gray-50">
        ...
        <label>
          ...
          <input className="border ml-2 rounded-lg px-2 align-middle"></input>
        </label>
        <label>
        ...
        <div className="grid justify-end">
          <button className="border bg-yellow-300 text-white font-bold text-xs w-20 h-6 px-1 rounded-full">
            Confirmer
          </button>
        </div>
      </fieldset>
